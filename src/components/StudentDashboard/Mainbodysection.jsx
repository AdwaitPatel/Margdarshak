...
const DashboardContent = () => {
  return (
    <div className="h-full">
      ...
      <div className="mb-8">
        <h2 className="text-xl mb-4 text-gray-200">Recommendations</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="border border-gray-200/10 rounded-lg p-6 h-32 flex items-center justify-center bg-gray-800/50">
            <span className="text-sm text-gray-400">Recommendation 1</span>
          </div>
          <div className="border border-gray-200/10 rounded-lg p-6 h-32 flex items-center justify-center bg-gray-800/50">
            <span className="text-sm text-gray-400">Recommendation 2</span>
          </div>
        </div>
      </div>
...
const Mainbodysection = ({ sidebarOpen, setSidebarOpen, selectedTab }) => {
  const renderContent = () => {
    switch (selectedTab) {
      case 'Dashboard':
