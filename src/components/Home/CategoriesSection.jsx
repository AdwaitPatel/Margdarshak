          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <button className="px-6 py-3 border-2 border-blue-400 text-blue-400 rounded-full font-medium hover:bg-blue-400 hover:text-white transition-all duration-300 hover:-translate-y-1 group-hover:shadow-lg group-hover:shadow-blue-400/25">
                  Explore
                </button>
              </div>
            </div>
